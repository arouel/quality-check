...
public class IllegalNonFinalStaticExceptionTest {

	@Test
	public void construct_withArgName_successful() {
		new IllegalNonFinalStaticException("className", "fieldName");
	}
	...
	public void construct_withFilledCause() {
		new IllegalNonFinalStaticException(new NumberFormatException());
	}
	...
	@Test
	public void construct_withNullClassNameAndNullCause() {
	...
	public void construct_withoutArgs_successful() {
		final IllegalNonFinalStaticException e = new IllegalNonFinalStaticException();
		Assert.assertEquals("The given class contains a non-final static variable.", e.getMessage());
	}
