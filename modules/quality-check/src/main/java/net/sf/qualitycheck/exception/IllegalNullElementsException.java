...
public class IllegalNullElementsException extends RuntimeException {
	 ...
	 *            the name of the passed argument
	 */
	public IllegalNullElementsException(final @Nullable String argumentName) {
	 ...
	 */
	public IllegalNullElementsException(final @Nullable String argumentName, final @Nullable Throwable cause) {
	 ...
	 *            {@code null} value is permitted, and indicates that the cause is nonexistent or unknown.)
	 */
	public IllegalNullElementsException(final @Nullable Throwable cause) {
